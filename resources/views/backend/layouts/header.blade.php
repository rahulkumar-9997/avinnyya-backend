    ...
    <div class="layout-width">
        <div class="navbar-header">
            <div class="d-flex">
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index.html" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="{{ asset('backend/assets/images/fav.png') }}" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="{{ asset('backend/assets/images/fav.png') }}" alt="" height="17">
                        </span>
                    </a>
            ...
            <div class="d-flex align-items-center">
                ...
                <a class="btn btn-success w-lg waves-effect waves-light" href="{{route('clear-cache')}}">Clear cache</a>
